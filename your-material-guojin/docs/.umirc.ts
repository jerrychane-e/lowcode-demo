...
const productPath = `/your-material-guojin@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('your-material-guojin', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'your-material-guojin': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
